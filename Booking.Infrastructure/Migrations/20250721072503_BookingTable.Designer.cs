...
namespace Booking.Infrastructure.Migrations
{
    ...
    [Migration("20250721072503_BookingTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Booking.Domain.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Booking.Domain.ApartmentPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Booking.Domain.Owner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Booking.Domain.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Booking.Domain.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApartmentOwner", b =>
                {
                    b.HasOne("Booking.Domain.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Booking.Domain.Owner", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Booking.Domain.ApartmentPhoto", b =>
                {
                    b.HasOne("Booking.Domain.Apartment", "Apartment")
            ...
            modelBuilder.Entity("Booking.Domain.Booking", b =>
                {
                    ...
                    b.HasOne("Booking.Domain.User", "User")
                        .WithMany("Bookings")
